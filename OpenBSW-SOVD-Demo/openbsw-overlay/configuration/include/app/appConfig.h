...
// FLXC1000 ECU Configuration - matches FLXC1000.mdd
...
// FLXC1000 MDD expects ECU at logical address 0x1000
static constexpr uint16_t LOGICAL_ADDRESS = 0x1000U;
#else
// Original OpenBSW demo address
